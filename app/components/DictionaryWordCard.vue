...
<template>
  <div
    ...
    <div
      class="absolute left-0 top-0 bottom-0 w-1 bg-plum transform -translate-x-full group-hover:translate-x-0 transition-transform duration-300">
    </div>
    ...
    <div class="flex items-center gap-2 self-end sm:self-start flex-shrink-0">
      ...
      <NuxtLink :to="`/read/${item.postId}#${item.anchorId}`"
