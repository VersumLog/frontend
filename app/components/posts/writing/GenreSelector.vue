...
const availableGenres = computed(() => {
  return props.allGenres.filter(g => !props.modelValue.includes(g))
})
  ...
  <div class="flex flex-wrap items-center gap-3 w-full">
    <div class="relative">
      ...
      >
        ...
        >
          <div v-if="availableGenres.length === 0" class="px-4 py-3 text-sm text-muted/70 text-center">
            Всі доступні жанри обрано
          </div>
          <div 
            v-else
